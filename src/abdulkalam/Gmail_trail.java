...
public class Gmail_trail {
	...
	public static void main(String[] args) throws Exception {
        ...
        ExtentTest et=er.startTest("Gmail mail count test");
        ...
        try {
        	...
        	int dmc=0;//pagination to count all mails
       // 	int eamc=0;
        	...
        	while(2>1)// infinite loop
        	{
        		...
        		for(int i=1;i<mc;i++) {
        			...
        			if(t.contains("May 9")&&t.contains("2018"))
        			{
        	...
        	System.out.println("Expected mail count"+dmc);
        	//get actual mails count i.e total mails value
        	String temp=driver.findElement(By.xpath("(//*[@class='ts'])[3]")).getText();
        	int aamc=Integer.parseInt(temp);
        	System.out.println("Actual mail count"+aamc);
        	//validation
        	if(dmc==aamc) {
